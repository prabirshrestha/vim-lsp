...
let g:lsp_signs_error = get(g:, 'lsp_signs_error', 'E>')
let g:lsp_signs_warning = get(g:, 'lsp_signs_warning', 'W>')
let g:lsp_signs_info = get(g:, 'lsp_signs_info', 'I>')
let g:lsp_signs_hint = get(g:, 'lsp_signs_hint', 'H>')
