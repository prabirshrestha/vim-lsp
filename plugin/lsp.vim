...
let g:lsp_signs_error = get(g:, 'lsp_signs_error', {'text': 'E>', 'texthl': 'Error'})
let g:lsp_signs_warning = get(g:, 'lsp_signs_warning', {'text': 'W>', 'texthl': 'Todo'})
let g:lsp_signs_information = get(g:, 'lsp_signs_information', {'text': 'I>', 'texthl': 'Normal'})
let g:lsp_signs_hint = get(g:, 'lsp_signs_hint', {'text': 'H>', 'texthl': 'Normal'})
